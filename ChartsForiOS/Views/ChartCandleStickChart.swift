...
struct ChartCandleStickChart: View {
    ...
    var body: some View {
        VStack{
            ...
            CandleStickChartViewResponse(data: entries )

        }
    }
}

struct ChartCandleStickChart_Previews: PreviewProvider {
