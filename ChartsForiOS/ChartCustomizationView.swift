...
//  ChartsForiOS
//
//  Created by Ali Alawami on 10/03/2022.
//
...
struct ChartCustomizationView: View {
    var chartTypes:[ChartColleciton] = [
        ChartColleciton(id:"Bar",view:AnyView(ChartsBarView()),imageName: "chart.bar"),
        ChartColleciton(id:"Line",view:AnyView(ChartLineView()), imageName: "chart.xyaxis.line"),
        ChartColleciton(id:"Pie",view:AnyView(ChartPieView()), imageName: "chart.pie.fill"),
        ChartColleciton(id:"Horizontal Bar",view:AnyView(ChartHBarView()),imageName: "chart.bar.doc.horizontal")]
...
struct ChartCustomizationView_Previews: PreviewProvider {
